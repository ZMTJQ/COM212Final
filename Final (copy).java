	...
	public static void run2(){
		...
		try{
			...
			if(inputNum==1){
				...
				MovieNode m1 = movieIDDirectory.search(inputChangeM);
				MovieNode m2 = movieDateDirectory.search(m1.getReleaseDate()); 
				MovieNode m3 = movieRTDirectory.search(m
				System.out.println(m.getName() + m.getCreditCard() + c.getEmail());
				...
				System.out.println("'3' change rotton tomatos");
				int numChange = in.nextInt();
				try{
					if(numChange==1){
